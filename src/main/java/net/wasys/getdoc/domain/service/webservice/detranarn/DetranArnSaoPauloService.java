...
@Service
public class DetranArnSaoPauloService extends DetranArnService {
	...
	protected String montarUrl(MultiValueMap<String, Object> parametrosAPI) {
		...
		MultiValueMap<String, String> stringMapParametrosAPI = super.toStringMultiValueMap(parametrosAPI);
		...
		String uriString = UriComponentsBuilder
				.fromHttpUrl(cwda.getEndPointSP())
