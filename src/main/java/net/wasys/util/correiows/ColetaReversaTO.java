...
public class ColetaReversaTO  extends net.wasys.util.correiows.ColetaTO  implements java.io.Serializable {
    ...
    private net.wasys.util.correiows.ObjetoTO[] obj_col;
    ...
    public ColetaReversaTO(
           ...
           net.wasys.util.correiows.ObjetoTO[] obj_col,
     ...
     * @return obj_col
     */
    public net.wasys.util.correiows.ObjetoTO[] getObj_col() {
        return obj_col;
    }
     ...
     * @param obj_col
     */
    public void setObj_col(net.wasys.util.correiows.ObjetoTO[] obj_col) {
        this.obj_col = obj_col;
    }

    public net.wasys.util.correiows.ObjetoTO getObj_col(int i) {
        return this.obj_col[i];
    }

    public void setObj_col(int i, net.wasys.util.correiows.ObjetoTO _value) {
