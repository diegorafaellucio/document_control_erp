...
public class RetornoCancelamentoTO  implements java.io.Serializable {
    ...
    private net.wasys.util.correiows.ObjetoSimplificadoTO objeto_postal;
    ...
    public RetornoCancelamentoTO(
           ...
           net.wasys.util.correiows.ObjetoSimplificadoTO objeto_postal) {
     ...
     */
    public net.wasys.util.correiows.ObjetoSimplificadoTO getObjeto_postal() {
        return objeto_postal;
    }
     ...
     * @param objeto_postal
     */
    public void setObjeto_postal(net.wasys.util.correiows.ObjetoSimplificadoTO objeto_postal) {
        this.objeto_postal = objeto_postal;
    }
