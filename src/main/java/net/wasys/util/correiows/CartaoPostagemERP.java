...
public class CartaoPostagemERP  implements java.io.Serializable {
    ...
    private net.wasys.util.correiows.ContratoERP[] contratos;
    ...
    private net.wasys.util.correiows.ServicoERP[] servicos;
    ...
    private net.wasys.util.correiows.UnidadePostagemERP[] unidadesPostagem;
    ...
    public CartaoPostagemERP(
           ...
           net.wasys.util.correiows.ContratoERP[] contratos,
           ...
           net.wasys.util.correiows.ServicoERP[] servicos,
           java.lang.String statusCartaoPostagem,
           java.lang.String statusCodigo,
           java.lang.String unidadeGenerica,
           net.wasys.util.correiows.UnidadePostagemERP[] unidadesPostagem) {
     ...
     * @return contratos
     */
    public net.wasys.util.correiows.ContratoERP[] getContratos() {
        return contratos;
    }
     ...
     * @param contratos
     */
    public void setContratos(net.wasys.util.correiows.ContratoERP[] contratos) {
        this.contratos = contratos;
    }

    public net.wasys.util.correiows.ContratoERP getContratos(int i) {
        return this.contratos[i];
    }

    public void setContratos(int i, net.wasys.util.correiows.ContratoERP _value) {
     ...
     * @return servicos
     */
    public net.wasys.util.correiows.ServicoERP[] getServicos() {
        return servicos;
    }
     ...
     * @param servicos
     */
    public void setServicos(net.wasys.util.correiows.ServicoERP[] servicos) {
        this.servicos = servicos;
    }

    public net.wasys.util.correiows.ServicoERP getServicos(int i) {
        return this.servicos[i];
    }

    public void setServicos(int i, net.wasys.util.correiows.ServicoERP _value) {
     ...
     */
    public net.wasys.util.correiows.UnidadePostagemERP[] getUnidadesPostagem() {
        return unidadesPostagem;
    }
     ...
     */
    public void setUnidadesPostagem(net.wasys.util.correiows.UnidadePostagemERP[] unidadesPostagem) {
        this.unidadesPostagem = unidadesPostagem;
    }

    public net.wasys.util.correiows.UnidadePostagemERP getUnidadesPostagem(int i) {
        return this.unidadesPostagem[i];
    }

    public void setUnidadesPostagem(int i, net.wasys.util.correiows.UnidadePostagemERP _value) {
