...
public class GerenteConta  implements java.io.Serializable {
    private net.wasys.util.correiows.ClienteERP[] clientesVisiveis;
    ...
    private net.wasys.util.correiows.StatusGerente status;

    private net.wasys.util.correiows.TipoGerente tipoGerente;

    private net.wasys.util.correiows.UsuarioInstalacao[] usuariosInstalacao;
    ...
    public GerenteConta(
           net.wasys.util.correiows.ClienteERP[] clientesVisiveis,
           ...
           net.wasys.util.correiows.StatusGerente status,
           net.wasys.util.correiows.TipoGerente tipoGerente,
           net.wasys.util.correiows.UsuarioInstalacao[] usuariosInstalacao,
     ...
     */
    public net.wasys.util.correiows.ClienteERP[] getClientesVisiveis() {
        return clientesVisiveis;
    }
     ...
     */
    public void setClientesVisiveis(net.wasys.util.correiows.ClienteERP[] clientesVisiveis) {
        this.clientesVisiveis = clientesVisiveis;
    }

    public net.wasys.util.correiows.ClienteERP getClientesVisiveis(int i) {
        return this.clientesVisiveis[i];
    }

    public void setClientesVisiveis(int i, net.wasys.util.correiows.ClienteERP _value) {
     ...
     * @return status
     */
    public net.wasys.util.correiows.StatusGerente getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(net.wasys.util.correiows.StatusGerente status) {
        this.status = status;
    }
     ...
     * @return tipoGerente
     */
    public net.wasys.util.correiows.TipoGerente getTipoGerente() {
        return tipoGerente;
    }
     ...
     * @param tipoGerente
     */
    public void setTipoGerente(net.wasys.util.correiows.TipoGerente tipoGerente) {
        this.tipoGerente = tipoGerente;
    }
     ...
     */
    public net.wasys.util.correiows.UsuarioInstalacao[] getUsuariosInstalacao() {
        return usuariosInstalacao;
    }
     ...
     */
    public void setUsuariosInstalacao(net.wasys.util.correiows.UsuarioInstalacao[] usuariosInstalacao) {
        this.usuariosInstalacao = usuariosInstalacao;
    }

    public net.wasys.util.correiows.UsuarioInstalacao getUsuariosInstalacao(int i) {
        return this.usuariosInstalacao[i];
    }

    public void setUsuariosInstalacao(int i, net.wasys.util.correiows.UsuarioInstalacao _value) {
