			...
			public void visit(String fieldName, Class type, Class definedIn, Object value) {
                ...
                if (converter != null) {
                    final String attribute = mapper.aliasForAttribute(mapper.serializedMember(
                        definedIn, fieldName));
                    //if (value != null) { //FIXME <---- commented out so that  null fields will be processed
...
//                    if (info.value != null) {//FIXME <----- added to write null fields as empty element!
...
//                    }
            ...
            void writeField(String fieldName, String aliasName, Class fieldType,
                ...
                if (newObj == null) {
                	writer.setValue(""); //FIXME <----- added to write null fields as empty element!
                }
                else {
    ...
    public Object doUnmarshal(final Object result, final HierarchicalStreamReader reader,
        ...
        while (it.hasNext()) {
            ...
            // TO DO: realMember should return FastField
            ...
            if (implicitCollectionMapping == null) {
                ...
                if (field == null) {
                    ...
                    if (field != null
                        ...
                        // TO DO the reflection provider should already return the proper field
