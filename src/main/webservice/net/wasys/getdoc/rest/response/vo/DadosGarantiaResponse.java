...
@ApiModel(value = "DadosGarantiaResponse")
public class DadosGarantiaResponse extends SuperVo {
    ...
    @ApiModelProperty(notes = "Lista Agente Certificado")
