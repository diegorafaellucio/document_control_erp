...
!function (t, e) {
    ...
    function t(u, f) {
        ...
        function w(t, e, n, o) {
            var r, a, i, c, l, s, d, o = Y(Y({}, f), o), p = {x: m, y: h, opts: o};
        ...
        function b(t, e) {
            var n, o, r, a, e = Y(Y({}, f), e), i = {scale: v, opts: e};
        ...
        E(f.startScale, {animate: !1, force: !0}), setTimeout(function () {
        ...
        function P(t) {
            var e, n, o;
            p && void 0 !== r && void 0 !== a && void 0 !== i && void 0 !== c && (T(M, t), e = N(M), n = 1 < M.length, o = v, n && (0 === d && (d = L(M)), S(o = b((L(M) - d) * f.step / 80 + s).scale, e, {animate: !1}, t)), n && !f.pinchAndPan || x(r + (e.clientX - i) / o, a + (e.clientY - c) / o, {animate: !1}, t))
        }
        ...
        function X() {
            z || (z = !0, D("down", f.canvas ? n : u, A), D("move", document, P, {passive: !0}), D("up", document, O, {passive: !0}))
        }

        return f.noBind || X(), {
            bind: X, destroy: function () {
                ...
                return n
            }, handleDown: A, handleMove: P, handleUp: O, pan: x, reset: function (t) {
                ...
                return W(u, t, e)
            }, zoom: E, zoomIn: function (t) {
                return o(!0, t)
            }, zoomOut: function (t) {
                return o(!1, t)
            }, zoomToPoint: S, zoomWithWheel: function (t, e) {
                t.preventDefault();
                var e = Y(Y(Y({}, f), e), {animate: !1}), n = 0 === t.deltaY && t.deltaX ? t.deltaX : t.deltaY;
