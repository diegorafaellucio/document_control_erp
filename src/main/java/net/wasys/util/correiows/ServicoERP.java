...
public class ServicoERP  implements java.io.Serializable {
    ...
    private net.wasys.util.correiows.ServicoSigep servicoSigep;

    private net.wasys.util.correiows.ServicoAdicionalERP[] servicosAdicionais;
    ...
    private net.wasys.util.correiows.VigenciaERP vigencia;
    ...
    public ServicoERP(
           ...
           long id,
           net.wasys.util.correiows.ServicoSigep servicoSigep,
           net.wasys.util.correiows.ServicoAdicionalERP[] servicosAdicionais,
           java.lang.String tipo1Codigo,
           java.lang.String tipo1Descricao,
           java.lang.String tipo2Codigo,
           java.lang.String tipo2Descricao,
           net.wasys.util.correiows.VigenciaERP vigencia) {
           this.codigo = codigo;
     ...
     * @return servicoSigep
     */
    public net.wasys.util.correiows.ServicoSigep getServicoSigep() {
        return servicoSigep;
    }
     ...
     * @param servicoSigep
     */
    public void setServicoSigep(net.wasys.util.correiows.ServicoSigep servicoSigep) {
        this.servicoSigep = servicoSigep;
    }
     ...
     */
    public net.wasys.util.correiows.ServicoAdicionalERP[] getServicosAdicionais() {
        return servicosAdicionais;
    }
     ...
     */
    public void setServicosAdicionais(net.wasys.util.correiows.ServicoAdicionalERP[] servicosAdicionais) {
        this.servicosAdicionais = servicosAdicionais;
    }

    public net.wasys.util.correiows.ServicoAdicionalERP getServicosAdicionais(int i) {
        return this.servicosAdicionais[i];
    }

    public void setServicosAdicionais(int i, net.wasys.util.correiows.ServicoAdicionalERP _value) {
     ...
     * @return vigencia
     */
    public net.wasys.util.correiows.VigenciaERP getVigencia() {
        return vigencia;
    }
     ...
     * @param vigencia
     */
    public void setVigencia(net.wasys.util.correiows.VigenciaERP vigencia) {
        this.vigencia = vigencia;
    }
