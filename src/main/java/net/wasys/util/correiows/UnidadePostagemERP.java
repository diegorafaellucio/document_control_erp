...
public class UnidadePostagemERP  implements java.io.Serializable {
    ...
    private net.wasys.util.correiows.EnderecoERP endereco;
    ...
    public UnidadePostagemERP(
           ...
           net.wasys.util.correiows.EnderecoERP endereco,
           java.lang.String id,
     ...
     * @return endereco
     */
    public net.wasys.util.correiows.EnderecoERP getEndereco() {
        return endereco;
    }
     ...
     * @param endereco
     */
    public void setEndereco(net.wasys.util.correiows.EnderecoERP endereco) {
        this.endereco = endereco;
    }
