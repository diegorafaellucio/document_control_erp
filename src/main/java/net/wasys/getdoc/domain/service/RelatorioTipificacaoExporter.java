...
@Service
@Scope("prototype")
public class RelatorioTipificacaoExporter extends AbstractProcessor {
	...
	private File file;
	private ImagemMetaFiltro filtro;
	...
	protected void execute2() {
		...
		try {
			...
			file = relatorioTipificacaoService.render(filtro);
			fileName = "relatorio-tipificacao.xlsx";
		}
		catch (Exception e) {
	...
	public void setFiltro(ImagemMetaFiltro filtro) {
		this.filtro = filtro;
	}
