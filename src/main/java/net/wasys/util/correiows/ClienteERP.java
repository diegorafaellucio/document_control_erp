...
public class ClienteERP  implements java.io.Serializable {
    ...
    private net.wasys.util.correiows.GerenteConta[] gerenteConta;
    ...
    public ClienteERP(
           ...
           net.wasys.util.correiows.GerenteConta[] gerenteConta,
     ...
     * @return gerenteConta
     */
    public net.wasys.util.correiows.GerenteConta[] getGerenteConta() {
        return gerenteConta;
    }
     ...
     * @param gerenteConta
     */
    public void setGerenteConta(net.wasys.util.correiows.GerenteConta[] gerenteConta) {
        this.gerenteConta = gerenteConta;
    }

    public net.wasys.util.correiows.GerenteConta getGerenteConta(int i) {
        return this.gerenteConta[i];
    }

    public void setGerenteConta(int i, net.wasys.util.correiows.GerenteConta _value) {
