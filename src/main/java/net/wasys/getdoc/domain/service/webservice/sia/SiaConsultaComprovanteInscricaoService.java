...
@Service
public class SiaConsultaComprovanteInscricaoService extends RestWebServiceClient {
	...
	protected ConsultaExterna chamarWebService(MultiValueMap<String, Object> parametros) {
		...
		Long timetout = configuracoesVO.getConsultaComprovanteInscricaoTimeout();
		int repeatTimes = configuracoesVO.getConsultaComprovanteInscricaoRepeattimes();
	...
	protected MultiValueMap<String, Object> getParametros(WebServiceClientVO vo) {
		...
		SiaConsultaComprovanteInscricaoVO vo2 = (SiaConsultaComprovanteInscricaoVO) vo;
