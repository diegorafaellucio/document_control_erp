...
///
Dynamsoft.WebTwainEnv.Containers = [{ContainerId:'dwtcontrolContainer', Width:630, Height:600}];
...
Dynamsoft.WebTwainEnv.ProductKey = 'f0068NQAAAC8QS9zVtGkJEihMG6vXGjN/IMVcTvSbGRxRtdXMVp8qKuFQQ/gKfKGGtc8EUVA7davo2Ebskrfi0RbhicI6L24=;f0068NQAAAGlZ8JQI/GWRjRUGlDLClebt6Ge+dISeFSuZQevtZ7v7Dnp6eUhHqmSgCt7snUVKqfA8ysj3D6e08s/QUEkQJGc=';

///
Dynamsoft.WebTwainEnv.Trial = false;

var resourcesPath = Dynamsoft.WebTwainEnv.ResourcesPath;

var path = window.location.pathname;

if(path.includes('/requisicoes/fila/edit/') > 0) {
	Dynamsoft.WebTwainEnv.ResourcesPath = '../../../resources/dwt';
} else if(path.includes('/requisicoes/edit/') > 0) {
	Dynamsoft.WebTwainEnv.ResourcesPath = '../../resources/dwt';
} else if(path.includes('/consultas/candidato/') > 0) {
	Dynamsoft.WebTwainEnv.ResourcesPath = '../../resources/dwt';
} else{
	Dynamsoft.WebTwainEnv.ResourcesPath = '../resources/dwt';
}
