...
@Service
@Scope("prototype")
public class RelatorioCandidatoExporter extends AbstractProcessor {

	@Autowired private RelatorioCandidatoService relatorioCandidatoService;
	...
	protected void execute2() {
		...
		try {
			...
			file = relatorioCandidatoService.render(filtro, usuario);
			fileName = "relatorio-candidato.xlsx";
		}
		catch (Exception e) {
