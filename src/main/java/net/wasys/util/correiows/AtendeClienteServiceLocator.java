...
public class AtendeClienteServiceLocator extends org.apache.axis.client.Service implements net.wasys.util.correiows.AtendeClienteService {
    ...
    public net.wasys.util.correiows.AtendeCliente getAtendeClientePort() throws javax.xml.rpc.ServiceException {
    ...
    public net.wasys.util.correiows.AtendeCliente getAtendeClientePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.wasys.util.correiows.AtendeClienteServiceSoapBindingStub _stub = new net.wasys.util.correiows.AtendeClienteServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.wasys.util.correiows.AtendeCliente.class.isAssignableFrom(serviceEndpointInterface)) {
                net.wasys.util.correiows.AtendeClienteServiceSoapBindingStub _stub = new net.wasys.util.correiows.AtendeClienteServiceSoapBindingStub(new java.net.URL(AtendeClientePort_address), this);
                _stub.setPortName(getAtendeClientePortWSDDServiceName());
                return _stub;
            }
        }
