...
public class ContratoERP  implements java.io.Serializable {
    private net.wasys.util.correiows.CartaoPostagemERP[] cartoesPostagem;

    private net.wasys.util.correiows.ClienteERP cliente;

    private long codigoCliente;

    private java.lang.String codigoDiretoria;

    private net.wasys.util.correiows.ContratoERPPK contratoPK;
    ...
    private net.wasys.util.correiows.UnidadePostagemERP diretoriaRegional;
    ...
    public ContratoERP(
           net.wasys.util.correiows.CartaoPostagemERP[] cartoesPostagem,
           net.wasys.util.correiows.ClienteERP cliente,
           long codigoCliente,
           java.lang.String codigoDiretoria,
           net.wasys.util.correiows.ContratoERPPK contratoPK,
           ...
           net.wasys.util.correiows.UnidadePostagemERP diretoriaRegional,
     ...
     */
    public net.wasys.util.correiows.CartaoPostagemERP[] getCartoesPostagem() {
        return cartoesPostagem;
    }
     ...
     */
    public void setCartoesPostagem(net.wasys.util.correiows.CartaoPostagemERP[] cartoesPostagem) {
        this.cartoesPostagem = cartoesPostagem;
    }

    public net.wasys.util.correiows.CartaoPostagemERP getCartoesPostagem(int i) {
        return this.cartoesPostagem[i];
    }

    public void setCartoesPostagem(int i, net.wasys.util.correiows.CartaoPostagemERP _value) {
     ...
     * @return cliente
     */
    public net.wasys.util.correiows.ClienteERP getCliente() {
        return cliente;
    }
     ...
     * @param cliente
     */
    public void setCliente(net.wasys.util.correiows.ClienteERP cliente) {
        this.cliente = cliente;
    }
     ...
     * @return contratoPK
     */
    public net.wasys.util.correiows.ContratoERPPK getContratoPK() {
        return contratoPK;
    }
     ...
     * @param contratoPK
     */
    public void setContratoPK(net.wasys.util.correiows.ContratoERPPK contratoPK) {
        this.contratoPK = contratoPK;
    }
     ...
     */
    public net.wasys.util.correiows.UnidadePostagemERP getDiretoriaRegional() {
        return diretoriaRegional;
    }
     ...
     */
    public void setDiretoriaRegional(net.wasys.util.correiows.UnidadePostagemERP diretoriaRegional) {
        this.diretoriaRegional = diretoriaRegional;
    }
