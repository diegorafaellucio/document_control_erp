...
public class PreListaPostagem  implements java.io.Serializable {
    private net.wasys.util.correiows.CartaoPostagemERP cartaoPostagem;
    ...
    private net.wasys.util.correiows.ObjetoPostal[] objetosPostais;
    ...
    private net.wasys.util.correiows.StatusPlp status;

    public PreListaPostagem() {
    }

    public PreListaPostagem(
           net.wasys.util.correiows.CartaoPostagemERP cartaoPostagem,
           ...
           net.wasys.util.correiows.ObjetoPostal[] objetosPostais,
           long plpCliente,
           long plpNu,
           org.apache.axis.types.UnsignedShort[] plpXml,
           org.apache.axis.types.UnsignedShort[] plpXmlRetorno,
           net.wasys.util.correiows.StatusPlp status) {
     ...
     */
    public net.wasys.util.correiows.CartaoPostagemERP getCartaoPostagem() {
        return cartaoPostagem;
    }
     ...
     */
    public void setCartaoPostagem(net.wasys.util.correiows.CartaoPostagemERP cartaoPostagem) {
        this.cartaoPostagem = cartaoPostagem;
    }
     ...
     */
    public net.wasys.util.correiows.ObjetoPostal[] getObjetosPostais() {
        return objetosPostais;
    }
     ...
     */
    public void setObjetosPostais(net.wasys.util.correiows.ObjetoPostal[] objetosPostais) {
        this.objetosPostais = objetosPostais;
    }

    public net.wasys.util.correiows.ObjetoPostal getObjetosPostais(int i) {
        return this.objetosPostais[i];
    }

    public void setObjetosPostais(int i, net.wasys.util.correiows.ObjetoPostal _value) {
     ...
     * @return status
     */
    public net.wasys.util.correiows.StatusPlp getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(net.wasys.util.correiows.StatusPlp status) {
        this.status = status;
    }
