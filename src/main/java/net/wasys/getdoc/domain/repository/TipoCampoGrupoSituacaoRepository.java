...
import net.wasys.getdoc.domain.entity.TipoCampoGrupoSituacao;
...
public class TipoCampoGrupoSituacaoRepository extends HibernateRepository<TipoCampoGrupoSituacao> {

	public TipoCampoGrupoSituacaoRepository() {
		super(TipoCampoGrupoSituacao.class);
	}

	public List<TipoCampoGrupoSituacao> findAll(Integer inicio, Integer max) {
