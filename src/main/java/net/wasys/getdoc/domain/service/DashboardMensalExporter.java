...
@Service
@Scope("prototype")
public class DashboardMensalExporter extends AbstractProcessor {
	...
	private DashboardMensalFiltro filtro;
	...
	protected void execute2() {
		...
		try {
			...
			Tipo tipo = Tipo.PROCESSOS;
			systraceThread("tipo: " + tipo);

			file = dashboardMensalService.render(filtro, usuario);
			fileName = "dashboard-mensal.xlsx";
	...
	public void setFiltro(DashboardMensalFiltro filtro) {
		this.filtro = filtro;
	}
