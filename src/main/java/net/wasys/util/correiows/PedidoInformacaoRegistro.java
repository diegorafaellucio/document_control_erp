...
public class PedidoInformacaoRegistro  extends net.wasys.util.correiows.PedidoInformacao  implements java.io.Serializable {
    private net.wasys.util.correiows.Cliente cliente;

    private java.lang.String codigoRegistro;

    private net.wasys.util.correiows.Conta conta;

    private java.lang.String conteudoObjeto;

    private java.lang.String cpfCnpj;

    private net.wasys.util.correiows.Destinatario destinatario;
    ...
    private net.wasys.util.correiows.Postagem postagem;

    private net.wasys.util.correiows.Remetente remetente;
    ...
    public PedidoInformacaoRegistro(
           ...
           net.wasys.util.correiows.Cliente cliente,
           java.lang.String codigoRegistro,
           net.wasys.util.correiows.Conta conta,
           java.lang.String conteudoObjeto,
           java.lang.String cpfCnpj,
           net.wasys.util.correiows.Destinatario destinatario,
           java.lang.String embalagem,
           java.lang.Integer motivo,
           java.lang.String observacao,
           net.wasys.util.correiows.Postagem postagem,
           net.wasys.util.correiows.Remetente remetente,
     ...
     * @return cliente
     */
    public net.wasys.util.correiows.Cliente getCliente() {
        return cliente;
    }
     ...
     * @param cliente
     */
    public void setCliente(net.wasys.util.correiows.Cliente cliente) {
        this.cliente = cliente;
    }
     ...
     * @return conta
     */
    public net.wasys.util.correiows.Conta getConta() {
        return conta;
    }
     ...
     * @param conta
     */
    public void setConta(net.wasys.util.correiows.Conta conta) {
        this.conta = conta;
    }
     ...
     * @return destinatario
     */
    public net.wasys.util.correiows.Destinatario getDestinatario() {
        return destinatario;
    }
     ...
     * @param destinatario
     */
    public void setDestinatario(net.wasys.util.correiows.Destinatario destinatario) {
        this.destinatario = destinatario;
    }
     ...
     * @return postagem
     */
    public net.wasys.util.correiows.Postagem getPostagem() {
        return postagem;
    }
     ...
     * @param postagem
     */
    public void setPostagem(net.wasys.util.correiows.Postagem postagem) {
        this.postagem = postagem;
    }
     ...
     * @return remetente
     */
    public net.wasys.util.correiows.Remetente getRemetente() {
        return remetente;
    }
     ...
     * @param remetente
     */
    public void setRemetente(net.wasys.util.correiows.Remetente remetente) {
        this.remetente = remetente;
    }
