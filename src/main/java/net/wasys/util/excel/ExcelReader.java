...
public class ExcelReader {
	...
	public String getString(Row row, int col) {
		...
		catch(com.monitorjbl.xlsx.exceptions.NotSupportedException e) {
			String value = cell.getStringCellValue();
			return value;
		}
	}
	...
	public int getColumnsNum(Row row, Integer numEsperado) {

		short lastCellNum = row.getLastCellNum();
		int lastColumn = lastCellNum;

		//se não bateu, então verifica se não tem colunas em branco
		if(numEsperado != null && lastCellNum != numEsperado) {
